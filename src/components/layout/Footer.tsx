...
export function Footer() {
  ...
  return (
    <footer className="border-t border-ink-900/8 bg-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.3fr] lg:gap-8 lg:px-6 lg:py-16">
        <div>
          <Image
            src="/logo.svg"
            alt="SHEMO PHARM"
          ...
          />
          <p className="mt-3 text-sm font-medium text-brand-700">{SITE.tagline}</p>
          <p className="mt-3 max-w-sm text-sm leading-relaxed text-ink-500">
            SHEMO PHARM furnizon barnatore dhe partnerë profesionalë në Kosovë me
            produkte mjekësore, ortopedike, suplemente dhe artikuj të kujdesit
            personal nga brende të njohura ndërkombëtare.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex gap-2">
            <a
              ...
              className="flex size-10 items-center justify-center rounded-full bg-brand-50 text-brand-700 transition-colors hover:bg-brand-600 hover:text-white"
            >
      ...
      <div className="border-t border-ink-900/6">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-5 text-center text-xs text-ink-400 sm:flex-row lg:px-6">
