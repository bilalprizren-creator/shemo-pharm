...
export const en: Dictionary = {
  ...
  nav: {
    ...
    wishlist: "Wishlist",
    cart: "Cart",
    cartWithCount: "Cart, {n} items",
    wishlistWithCount: "Wishlist, {n} items",
    catalog: "Catalog",
  ...
  catalog: {
    ...
    emptySearchEverywhere: "Search all products for \"{q}\"",
    emptyIncludeOutOfStock: "Show out-of-stock products too",
    share: "Share",
